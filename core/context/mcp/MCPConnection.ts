...
For personal use you can set the secret in the hub at https://black-code.ai/settings/secrets.
Org-level secrets can only be used for MCP by Background Agents (https://docs.black-code.ai/hub/agents/overview) when \"Include in Env\" is enabled.`,
      );
    }
