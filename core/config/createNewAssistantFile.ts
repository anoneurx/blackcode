...
# To learn more, see the full config.yaml reference: https://docs.black-code.ai/reference
...
# https://docs.black-code.ai/customization/models
models:
  - name: my gpt-5
    provider: openai
    model: gpt-5
...
# https://docs.black-code.ai/customization/mcp-tools
mcpServers:
